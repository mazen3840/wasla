...
class SaleByCountry extends StatefulWidget {
  ...
  const SaleByCountry({super.key, required this.controller});
...
class _SaleByCountryState extends State<SaleByCountry> {
  ...
  void initState() {
    ...
    dataMap = convertIntMapToDouble(
        widget.controller.ReportData!.data.statistics.sale);
    colorList = generateRandomColorList(
        widget.controller.ReportData!.data.statistics.saleCount!);
  }
  ...
  Widget build(BuildContext context) {
    ...
    dataMap = convertIntMapToDouble(bannModel.sale);
    return Container(
      ...
      child: Column(
        children: [
          ...
          PieChart(
            ...
            totalValue: widget
                .controller.ReportData!.data.statistics.saleCount!
                .toDouble(),
          ),
        ],
      ),
